...
|---|---|---|
| 0.1.2 | `openclaw-v0.1.2` | `@@FES_PIN_SHA@@` (tag commit SHA) |
...
```bash
git clone --depth 1 --branch openclaw-v0.1.2 \
...
test "$(git -C "$FES_ROOT" rev-parse HEAD)" = "@@FES_PIN_SHA@@" || abort (pin mismatch)
```
